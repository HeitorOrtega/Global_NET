...
namespace GsNetApi.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        public LoginController(ILoginService service, LinkGenerator linkGenerator)
        {
            _service = service;
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] Login entity)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(long id, [FromBody] Login entity)
        {
